...
module.exports = Object.freeze({
  ...
  //port: 3000,
  port: 443,
  remoteUrl:"https://qa.share.place/",
  debugServer: false,
  defaultPicture: path.join(__dirname, 'static', "images", "img_profile.png"),
  dataDir: path.join(__dirname, '..', "data"),
  usersFileData: path.join(__dirname, '..', "data", "users.json"),
  logDir: path.join(__dirname, "log"),
  urlLoginProxy: 'https://qa.share.place/auth',
  optionsPost: {
  ...
  urlFbLogin : "https://qa.share.place/auth/facebook/d/",
  urlGlogin : "https://qa.share.place/auth/google/d/",
  /*
  optionsGetFromAuth: {
   host: "127.0.0.1",
   port: 3000,
