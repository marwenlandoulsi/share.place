...
5. Publish with the `publish.sh` script or use npm run build:win:

        ./publish.sh

6. Release the release on GitHub by going to <https://github.com/marwenlandoulsi/etestAppElec/releases>, editing the release and clicking "Publish release."

7. Download and install the app from <https://github.com/marwenlandoulsi/testAppElec/releases>.
