...
import 'package:share_place/common/util.template.dart' as i11;
...
import 'common/ui/text_comp.dart' as import6;
import 'package:angular2_components/src/components/material_expansionpanel/material_expansionpanel_set.dart' as import7;
...
import 'common/ui/text_comp.template.dart' as import13;
...
import 'package:angular2_components/src/components/material_expansionpanel/material_expansionpanel.dart' as import18;
import 'package:angular2/src/common/directives/ng_if.dart';
import 'package:angular2_components/src/components/material_expansionpanel/material_expansionpanel.template.dart' as import20;
import 'package:angular2_components/src/utils/angular/managed_zone/src/managed_zone.dart' as import21;
import 'package:angular2_components/src/components/content/deferred_content_aware.dart' as import22;
import 'folder/folder_component.dart' as import23;
import 'users/place_user_list_provider.dart' as import24;
import 'users/users_comp.dart' as import25;
import 'folder/folder_component.template.dart' as import26;
...
import 'users/users_comp.template.dart' as import30;
import 'package:angular2/src/security/dom_sanitization_service.dart' as import31;
import 'package:angular2/src/core/linker/component_factory.dart' as import32;
...
class ViewPlacesComponent0 extends AppView<import3.PlacesComponent> {
  ...
  import6.TextComp _TextComp_23_3;
  Element _el_26;
  import7.MaterialExpansionPanelSet _MaterialExpansionPanelSet_26_2;
  import8.QueryList _query_MaterialExpansionPanel_26_0;
  ...
  ViewContainer createInternal(dynamic rootSelector) {
    ...
    _el_23 = doc.createElement('txt');
    _el_23.setAttribute(shimCAttr,'');
    _el_21.append(_el_23);
    _el_23.className = 'saveAdd';
    _appEl_23 = new ViewContainer(23,21,this,_el_23);
    var compView_23 = import13.viewFactory_TextComp0(this.injector(23),_appEl_23);
    _TextComp_23_3 = new import6.TextComp();
    _appEl_23.initComponent(_TextComp_23_3,compView_23);
    compView_23.createComp([],null);
    Text _text_24 = new Text('\n      ');
    _el_21.append(_text_24);
    Text _text_25 = new Text('\n\n      ');
    _el_16.append(_text_25);
    _el_26 = doc.createElement('material-expansionpanel-set');
    _el_26.setAttribute(shimCAttr,'');
    _el_16.append(_el_26);
    _MaterialExpansionPanelSet_26_2 = new import7.MaterialExpansionPanelSet();
    _query_MaterialExpansionPanel_26_0 = new import8.QueryList();
    ...
    _TemplateRef_28_4 = new TemplateRef(_appEl_28,viewFactory_PlacesComponent1);
    _NgFor_28_5 = new import9.NgFor(_appEl_28,_TemplateRef_28_4,this.parentInjector.get(import15.IterableDiffers),ref);
    ...
    init([],[
      ...
      _el_21,_text_22,_el_23,_text_24,_text_25,_el_26,_text_27,_anchor_28,_text_29,_text_30,
      _text_31,_text_32
    ]
    ,[]);
    return null;
  ...
  dynamic injectorGetInternal(dynamic token,int requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import6.TextComp) && (23 == requestNodeIndex))) { return _TextComp_23_3; }
    if ((identical(token, TemplateRef) && (28 == requestNodeIndex))) { return _TemplateRef_28_4; }
    if ((identical(token, import9.NgFor) && (28 == requestNodeIndex))) { return _NgFor_28_5; }
    if ((identical(token, import7.MaterialExpansionPanelSet) && ((26 <= requestNodeIndex) && (requestNodeIndex <= 29)))) { return _MaterialExpansionPanelSet_26_2; }
    return notFoundResult;
  }
  void detectChangesInternal() {
    final currVal_2 = ctx.save;
    if (import16.checkBinding(_expr_2,currVal_2)) {
      _TextComp_23_3.confirm = currVal_2;
      _expr_2 = currVal_2;
    }
    final currVal_3 = _arr_0('../images/ok.png','../images/ok.png','../images/ok.png');
    if (import16.checkBinding(_expr_3,currVal_3)) {
      _TextComp_23_3.sources = currVal_3;
      _expr_3 = currVal_3;
    }
    ...
    if (!import16.AppViewUtils.throwOnChanges) { _NgFor_28_5.ngDoCheck(); }
  ...
  bool _handle_click_8_0($event) {
    ...
    ctx.add();
    final dynamic pd_0 = !identical((_TextComp_23_3.focus('places') as dynamic), false);
    return (true && pd_0);
  }
}
AppView viewFactory_PlacesComponent0(import11.Injector parentInjector,ViewContainer declarationEl) {
  if (identical(renderType_PlacesComponent, null)) { (renderType_PlacesComponent = import16.appViewUtils.createRenderComponentType('',0,import17.ViewEncapsulation.Emulated,styles_PlacesComponent)); }
...
class ViewPlacesComponent1 extends AppView<import3.PlacesComponent> {
  ...
  import18.MaterialExpansionPanel _MaterialExpansionPanel_0_3;
  ...
  var _expr_1 = uninitialized;
  var _expr_2 = uninitialized;
  ViewPlacesComponent1(import11.Injector parentInjector,ViewContainer declarationEl): super(ViewPlacesComponent1,renderType_PlacesComponent,import12.ViewType.EMBEDDED,{'\$implicit': null},parentInjector,declarationEl,ChangeDetectionStrategy.CheckAlways);
  ...
  ViewContainer createInternal(dynamic rootSelector) {
    ...
    var compView_0 = import20.viewFactory_MaterialExpansionPanel0(this.injector(0),_appEl_0);
    _MaterialExpansionPanel_0_3 = new import18.MaterialExpansionPanel(this.parentInjector.get(import21.ManagedZone),compView_0.ref);
  ...
  dynamic injectorGetInternal(dynamic token,int requestNodeIndex,dynamic notFoundResult) {
    ...
    if ((identical(token, import18.MaterialExpansionPanel) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) { return _MaterialExpansionPanel_0_3; }
    if ((identical(token, import22.DeferredContentAware) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) { return _DeferredContentAware_0_4; }
    return notFoundResult;
  }
  void detectChangesInternal() {
    bool changed = true;
    changed = false;
    final currVal_1 = import16.interpolate0(locals['\$implicit'].name);
    if (import16.checkBinding(_expr_1,currVal_1)) {
    ...
    if ((identical(this.cdState, ChangeDetectorState.NeverChecked) && !import16.AppViewUtils.throwOnChanges)) { _MaterialExpansionPanel_0_3.ngOnInit(); }
    _NgIf_2_5.ngIf = (((locals['\$implicit'] == null)? null: locals['\$implicit'].id) == ((ctx.selectedPlace == null)? null: ctx.selectedPlace.id));
    this.detectContentChildrenChanges();
    this.detectViewChildrenChanges();
  }
  void dirtyParentQueriesInternal() {
    (parent as ViewPlacesComponent0)._query_MaterialExpansionPanel_26_0.setDirty();
  }
  void destroyInternal() {
...
AppView viewFactory_PlacesComponent1(import11.Injector parentInjector,ViewContainer declarationEl) {
...
class ViewPlacesComponent2 extends AppView<import3.PlacesComponent> {
  ...
  Element _el_2;
  ViewContainer _appEl_2;
  import23.FolderComponent _FolderComponent_2_3;
  Element _el_4;
  ViewContainer _appEl_4;
  import24.PlaceUserListProvider _PlaceUserListProvider_4_3;
  import25.UsersComp _UsersComp_4_4;
  ViewPlacesComponent2(import11.Injector parentInjector,ViewContainer declarationEl): super(ViewPlacesComponent2,renderType_PlacesComponent,import12.ViewType.EMBEDDED,{},parentInjector,declarationEl,ChangeDetectionStrategy.CheckAlways);
  ViewContainer createInternal(dynamic rootSelector) {
    var doc = document;
    _el_0 = doc.createElement('div');
    _el_0.setAttribute(shimCAttr,'');
    ...
    var compView_2 = import26.viewFactory_FolderComponent0(this.injector(2),_appEl_2);
    _FolderComponent_2_3 = new import23.FolderComponent(this.parentInjector.get(import27.PlaceService),this.parentInjector.get(import28.Router),this.parentInjector.get(import29.Environment));
    ...
    var compView_4 = import30.viewFactory_UsersComp0(this.injector(4),_appEl_4);
    _PlaceUserListProvider_4_3 = new import24.PlaceUserListProvider(this.parentInjector.get(import29.Environment),this.parentInjector.get(import27.PlaceService));
    _UsersComp_4_4 = new import25.UsersComp(this.parentInjector.get(import27.PlaceService),this.parentInjector.get(import28.Router),this.parentInjector.get(import29.Environment),this.parentInjector.get(import31.DomSanitizationService),_PlaceUserListProvider_4_3);
  ...
  dynamic injectorGetInternal(dynamic token,int requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import23.FolderComponent) && (2 == requestNodeIndex))) { return _FolderComponent_2_3; }
    if ((identical(token, import24.PlaceUserListProvider) && (4 == requestNodeIndex))) { return _PlaceUserListProvider_4_3; }
    if ((identical(token, import25.UsersComp) && (4 == requestNodeIndex))) { return _UsersComp_4_4; }
    return notFoundResult;
  }
  void detectChangesInternal() {
    if ((identical(this.cdState, ChangeDetectorState.NeverChecked) && !import16.AppViewUtils.throwOnChanges)) { _FolderComponent_2_3.ngOnInit(); }
    if ((identical(this.cdState, ChangeDetectorState.NeverChecked) && !import16.AppViewUtils.throwOnChanges)) { _UsersComp_4_4.ngOnInit(); }
    this.detectContentChildrenChanges();
    this.detectViewChildrenChanges();
  }
}
AppView viewFactory_PlacesComponent2(import11.Injector parentInjector,ViewContainer declarationEl) {
...
class ViewPlacesComponentHost0 extends AppView<dynamic> {
  ...
  ViewPlacesComponentHost0(import11.Injector parentInjector,ViewContainer declarationEl): super(ViewPlacesComponentHost0,renderType_PlacesComponentHost,import12.ViewType.HOST,{},parentInjector,declarationEl,ChangeDetectionStrategy.CheckAlways);
  ViewContainer createInternal(dynamic rootSelector) {
    ...
    _PlacesComponent_0_3 = new import3.PlacesComponent(this.parentInjector.get(import27.PlaceService),this.parentInjector.get(import28.Router),this.parentInjector.get(import29.Environment));
  ...
  void detectChangesInternal() {
    if ((identical(this.cdState, ChangeDetectorState.NeverChecked) && !import16.AppViewUtils.throwOnChanges)) { _PlacesComponent_0_3.ngOnInit(); }
    this.detectContentChildrenChanges();
    this.detectViewChildrenChanges();
  }
}
AppView viewFactory_PlacesComponentHost0(import11.Injector parentInjector,ViewContainer declarationEl) {
  if (identical(renderType_PlacesComponentHost, null)) { (renderType_PlacesComponentHost = import16.appViewUtils.createRenderComponentType('',0,import17.ViewEncapsulation.Emulated,styles_PlacesComponentHost)); }
  return new ViewPlacesComponentHost0(parentInjector,declarationEl);
}
const import32.ComponentFactory PlacesComponentNgFactory = const import32.ComponentFactory('places',viewFactory_PlacesComponentHost0,import3.PlacesComponent,_METADATA);
