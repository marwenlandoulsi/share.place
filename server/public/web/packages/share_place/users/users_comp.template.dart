...
class ViewUsersComp0 extends AppView<import2.UsersComp> {
  ...
  ComponentRef build() {
    ...
    _el_11.className = 'people';
    addShimC(_el_11);
    Text _text_12 = new Text('\n    ');
    _el_11.append(_text_12);
    _el_13 = createAndAppend(doc,'div',_el_11);
    _el_13.className = 'scrollbar-macosx_';
    addShimC(_el_13);
    Text _text_14 = new Text('\n\n      ');
    _el_13.append(_text_14);
    _el_15 = createAndAppend(doc,'ul',_el_13);
    _el_15.className = 'list';
    addShimC(_el_15);
    Text _text_16 = new Text('\n        ');
    _el_15.append(_text_16);
    _el_17 = createAndAppend(doc,'div',_el_15);
    _el_17.className = 'spinnerInner';
    addShimC(_el_17);
    ...
    TemplateRef _TemplateRef_19_4 = new TemplateRef(_appEl_19,viewFactory_UsersComp1);
    ...
    _el_15.append(_anchor_22);
    _appEl_22 = new ViewContainer(22,15,this,_anchor_22);
  ...
  void detectChangesInternal() {
    final import2.UsersComp _ctx = ctx;
    _NgIf_19_5.ngIf = (_ctx.users == null);
