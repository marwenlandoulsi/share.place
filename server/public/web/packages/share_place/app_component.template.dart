...
class ViewAppComponent0 extends AppView<import3.AppComponent> {
  ...
  import7.Notification _Notification_14_3;
  ...
  Element _el_21;
  Element _el_23;
  import8.PopupSourceDirective _PopupSourceDirective_23_2;
  ...
  import9.PostitComponent _PostitComponent_34_3;
  Element _el_36;
  ViewContainer _appEl_36;
  import10.PlacesComponent _PlacesComponent_36_3;
  Element _el_39;
  Element _el_41;
  Element _el_43;
  Element _el_45;
  ...
  import11.UserListProvider _UserListProvider_47_3;
  import12.SubjectListComponent _SubjectListComponent_47_4;
  Element _el_50;
  Element _el_52;
  Element _el_54;
  Element _el_56;
  ViewContainer _appEl_56;
  import13.FilesComp _FilesComp_56_3;
  dynamic __defaultPopupPositions_56_4;
  import14.Angular2ManagedZone __ManagedZone_56_5;
  dynamic __Window_56_6;
  dynamic __DomService_56_7;
  import15.AcxImperativeViewUtils __AcxImperativeViewUtils_56_8;
  dynamic __Document_56_9;
  import16.DomRuler __DomRuler_56_10;
  dynamic __overlayContainerName_56_11;
  dynamic __overlayContainerParent_56_12;
  dynamic __overlayContainerToken_56_13;
  dynamic __overlaySyncDom_56_14;
  import17.OverlayStyleConfig __OverlayStyleConfig_56_15;
  import18.ZIndexer __ZIndexer_56_16;
  import19.OverlayDomRenderService __OverlayDomRenderService_56_17;
  import20.OverlayDomService __OverlayService_56_18;
  import21.DomPopupSourceFactory __DomPopupSourceFactory_56_19;
  import22.PopupService __PopupService_56_20;
  ...
  dynamic get _defaultPopupPositions_56_4 {
    if ((this.__defaultPopupPositions_56_4 == null)) { (__defaultPopupPositions_56_4 = import26.inlinePositions); }
    return this.__defaultPopupPositions_56_4;
  }
  import14.Angular2ManagedZone get _ManagedZone_56_5 {
    if ((this.__ManagedZone_56_5 == null)) { (__ManagedZone_56_5 = new import14.Angular2ManagedZone(this.parentInjector.get(import27.NgZone))); }
    return this.__ManagedZone_56_5;
  }
  dynamic get _Window_56_6 {
    if ((this.__Window_56_6 == null)) { (__Window_56_6 = import28.getWindow()); }
    return this.__Window_56_6;
  }
  dynamic get _DomService_56_7 {
    if ((this.__DomService_56_7 == null)) { (__DomService_56_7 = import29.createDomService(this.parentInjector.get(import30.DomService,null),this.parentInjector.get(import31.Disposer,null),this._ManagedZone_56_5,this._Window_56_6)); }
    return this.__DomService_56_7;
  }
  import15.AcxImperativeViewUtils get _AcxImperativeViewUtils_56_8 {
    if ((this.__AcxImperativeViewUtils_56_8 == null)) { (__AcxImperativeViewUtils_56_8 = new import15.AcxImperativeViewUtils(this.parentInjector.get(import32.DynamicComponentLoader),this._DomService_56_7)); }
    return this.__AcxImperativeViewUtils_56_8;
  }
  dynamic get _Document_56_9 {
    if ((this.__Document_56_9 == null)) { (__Document_56_9 = import28.getDocument()); }
    return this.__Document_56_9;
  }
  import16.DomRuler get _DomRuler_56_10 {
    if ((this.__DomRuler_56_10 == null)) { (__DomRuler_56_10 = new import16.DomRuler(this._Document_56_9,this._DomService_56_7)); }
    return this.__DomRuler_56_10;
  }
  dynamic get _overlayContainerName_56_11 {
    if ((this.__overlayContainerName_56_11 == null)) { (__overlayContainerName_56_11 = 'default'); }
    return this.__overlayContainerName_56_11;
  }
  dynamic get _overlayContainerParent_56_12 {
    if ((this.__overlayContainerParent_56_12 == null)) { (__overlayContainerParent_56_12 = import33.getOverlayContainerParent(this._Document_56_9)); }
    return this.__overlayContainerParent_56_12;
  }
  dynamic get _overlayContainerToken_56_13 {
    if ((this.__overlayContainerToken_56_13 == null)) { (__overlayContainerToken_56_13 = import33.getDefaultContainer(this._overlayContainerName_56_11,this._overlayContainerParent_56_12)); }
    return this.__overlayContainerToken_56_13;
  }
  dynamic get _overlaySyncDom_56_14 {
    if ((this.__overlaySyncDom_56_14 == null)) { (__overlaySyncDom_56_14 = true); }
    return this.__overlaySyncDom_56_14;
  }
  import17.OverlayStyleConfig get _OverlayStyleConfig_56_15 {
    if ((this.__OverlayStyleConfig_56_15 == null)) { (__OverlayStyleConfig_56_15 = new import17.OverlayStyleConfig(this._Document_56_9)); }
    return this.__OverlayStyleConfig_56_15;
  }
  import18.ZIndexer get _ZIndexer_56_16 {
    if ((this.__ZIndexer_56_16 == null)) { (__ZIndexer_56_16 = new import18.ZIndexer()); }
    return this.__ZIndexer_56_16;
  }
  import19.OverlayDomRenderService get _OverlayDomRenderService_56_17 {
    if ((this.__OverlayDomRenderService_56_17 == null)) { (__OverlayDomRenderService_56_17 = new import19.OverlayDomRenderService(this._OverlayStyleConfig_56_15,this._overlayContainerToken_56_13,this._overlayContainerName_56_11,this._DomRuler_56_10,this._DomService_56_7,this._AcxImperativeViewUtils_56_8,this._overlaySyncDom_56_14,this._ZIndexer_56_16)); }
    return this.__OverlayDomRenderService_56_17;
  }
  import20.OverlayDomService get _OverlayService_56_18 {
    if ((this.__OverlayService_56_18 == null)) { (__OverlayService_56_18 = new import20.OverlayDomService(this.parentInjector.get(import27.NgZone),this._overlaySyncDom_56_14,this._OverlayDomRenderService_56_17,this.parentInjector.get(import34.OverlayService,null))); }
    return this.__OverlayService_56_18;
  }
  import21.DomPopupSourceFactory get _DomPopupSourceFactory_56_19 {
    if ((this.__DomPopupSourceFactory_56_19 == null)) { (__DomPopupSourceFactory_56_19 = new import21.DomPopupSourceFactory(this._Window_56_6,this._DomRuler_56_10)); }
    return this.__DomPopupSourceFactory_56_19;
  }
  import22.PopupService get _PopupService_56_20 {
    if ((this.__PopupService_56_20 == null)) { (__PopupService_56_20 = new import22.PopupService(this._defaultPopupPositions_56_4,this._OverlayService_56_18,this._ZIndexer_56_16)); }
    return this.__PopupService_56_20;
  }
  ViewContainer createInternal(dynamic rootSelector) {
    ...
    _TemplateRef_10_4 = new TemplateRef(_appEl_10,viewFactory_AppComponent3);
    ...
    _el_6.append(_el_12);
    _el_12.className = 'alertInner';
    Text _text_13 = new Text('\n      ');
    _el_12.append(_text_13);
    _el_14 = doc.createElement('notification');
    _el_14.setAttribute(shimCAttr,'');
    _el_12.append(_el_14);
    _el_14.className = 'notif error';
    _appEl_14 = new ViewContainer(14,12,this,_el_14);
    var compView_14 = import36.viewFactory_Notification0(this.injector(14),_appEl_14);
    _Notification_14_3 = new import7.Notification();
    _appEl_14.initComponent(_Notification_14_3,compView_14);
    ...
    _TemplateRef_16_4 = new TemplateRef(_appEl_16,viewFactory_AppComponent4);
    _NgIf_16_5 = new NgIf(_appEl_16,_TemplateRef_16_4);
    Text _text_17 = new Text('\n    ');
    _el_12.append(_text_17);
    Text _text_18 = new Text('\n    ');
    _el_6.append(_text_18);
    _el_19 = doc.createElement('div');
    _el_19.setAttribute(shimCAttr,'');
    _el_6.append(_el_19);
    _el_19.className = 'rightMenu';
    Text _text_20 = new Text('\n      ');
    _el_19.append(_text_20);
    _el_21 = doc.createElement('div');
    _el_21.setAttribute(shimCAttr,'');
    _el_19.append(_el_21);
    _el_21.className = 'imgProfil';
    Text _text_22 = new Text('\n        ');
    _el_21.append(_text_22);
    _el_23 = doc.createElement('img');
    _el_23.setAttribute(shimCAttr,'');
    _el_21.append(_el_23);
    createAttr(_el_23,'alignPositionX','end');
    createAttr(_el_23,'alignPositionY','after');
    _el_23.className = 'profileImg';
    createAttr(_el_23,'popupSource','');
    _PopupSourceDirective_23_2 = new import8.PopupSourceDirective(this.parentInjector.get(import21.DomPopupSourceFactory),new ElementRef(_el_23),this.parentInjector.get(import38.ReferenceDirective,null));
    Text _text_24 = new Text('\n      ');
    _el_19.append(_text_24);
    Text _text_25 = new Text('\n      ');
    _el_19.append(_text_25);
    var _anchor_26 = new Comment('template bindings={}');
    _el_19?.append(_anchor_26);
    _appEl_26 = new ViewContainer(26,19,this,_anchor_26);
    ...
    _TemplateRef_28_4 = new TemplateRef(_appEl_28,viewFactory_AppComponent7);
    _NgIf_28_5 = new NgIf(_appEl_28,_TemplateRef_28_4);
    Text _text_29 = new Text('\n    ');
    _el_19.append(_text_29);
    Text _text_30 = new Text('\n  ');
    _el_6.append(_text_30);
    Text _text_31 = new Text('\n\n  ');
    _el_0.append(_text_31);
    _el_32 = doc.createElement('div');
    _el_32.setAttribute(shimCAttr,'');
    _el_0.append(_el_32);
    _el_32.className = 'leftP';
    Text _text_33 = new Text('\n    ');
    _el_32.append(_text_33);
    _el_34 = doc.createElement('postit-comp');
    _el_34.setAttribute(shimCAttr,'');
    _el_32.append(_el_34);
    _el_34.className = 'placesPostit';
    _appEl_34 = new ViewContainer(34,32,this,_el_34);
    var compView_34 = import39.viewFactory_PostitComponent0(this.injector(34),_appEl_34);
    _PostitComponent_34_3 = new import9.PostitComponent(this.parentInjector.get(import40.PlaceService),this.parentInjector.get(import41.Router),this.parentInjector.get(import42.Environment));
    _appEl_34.initComponent(_PostitComponent_34_3,compView_34);
    compView_34.createComp([],null);
    Text _text_35 = new Text('\n    ');
    _el_32.append(_text_35);
    _el_36 = doc.createElement('places');
    _el_36.setAttribute(shimCAttr,'');
    _el_32.append(_el_36);
    _appEl_36 = new ViewContainer(36,32,this,_el_36);
    var compView_36 = import43.viewFactory_PlacesComponent0(this.injector(36),_appEl_36);
    _PlacesComponent_36_3 = new import10.PlacesComponent(this.parentInjector.get(import40.PlaceService),this.parentInjector.get(import41.Router),this.parentInjector.get(import42.Environment));
    _appEl_36.initComponent(_PlacesComponent_36_3,compView_36);
    compView_36.createComp([],null);
    Text _text_37 = new Text('\n  ');
    _el_32.append(_text_37);
    Text _text_38 = new Text('\n  ');
    _el_0.append(_text_38);
    _el_39 = doc.createElement('div');
    _el_39.setAttribute(shimCAttr,'');
    _el_0.append(_el_39);
    _el_39.className = 'rightPanelinside';
    ...
    _el_41.className = 'rightPanelinside_header';
    ...
    _el_45.className = 'centerP';
    Text _text_46 = new Text('\n        ');
    _el_45.append(_text_46);
    _el_47 = doc.createElement('subjects');
    _el_47.setAttribute(shimCAttr,'');
    _el_45.append(_el_47);
    _appEl_47 = new ViewContainer(47,45,this,_el_47);
    var compView_47 = import44.viewFactory_SubjectListComponent0(this.injector(47),_appEl_47);
    _UserListProvider_47_3 = new import11.UserListProvider(this.parentInjector.get(import42.Environment),this.parentInjector.get(import40.PlaceService));
    _SubjectListComponent_47_4 = new import12.SubjectListComponent(this.parentInjector.get(import40.PlaceService),this.parentInjector.get(import41.Router),this.parentInjector.get(import42.Environment),_UserListProvider_47_3,this.parentInjector.get(import45.DomSanitizationService));
    _appEl_47.initComponent(_SubjectListComponent_47_4,compView_47);
    ...
    _el_54.className = 'files';
    Text _text_55 = new Text('\n            ');
    _el_54.append(_text_55);
    _el_56 = doc.createElement('files-comp');
    _el_56.setAttribute(shimCAttr,'');
    _el_54.append(_el_56);
    _appEl_56 = new ViewContainer(56,54,this,_el_56);
    var compView_56 = import46.viewFactory_FilesComp0(this.injector(56),_appEl_56);
    _FilesComp_56_3 = new import13.FilesComp(this.parentInjector.get(import40.PlaceService),this.parentInjector.get(import41.Router),this.parentInjector.get(import42.Environment));
    _appEl_56.initComponent(_FilesComp_56_3,compView_56);
    compView_56.createComp([],null);
    Text _text_57 = new Text('\n          ');
    _el_54.append(_text_57);
    Text _text_58 = new Text('\n        ');
    _el_52.append(_text_58);
    Text _text_59 = new Text('\n      ');
    _el_50.append(_text_59);
    Text _text_60 = new Text('\n    ');
    _el_43.append(_text_60);
    Text _text_61 = new Text('\n  ');
    _el_39.append(_text_61);
    Text _text_62 = new Text('\n  ');
    _el_0.append(_text_62);
    Text _text_63 = new Text('\n');
    _el_0.append(_text_63);
    listen(_el_23,'click',evt(_handle_click_23_0));
    init([],[
      _el_0,_text_1,_anchor_2,_text_3,_anchor_4,_text_5,_el_6,_text_7,_el_8,_text_9,_anchor_10,
      _text_11,_el_12,_text_13,_el_14,_text_15,_anchor_16,_text_17,_text_18,_el_19,_text_20,
      _el_21,_text_22,_el_23,_text_24,_text_25,_anchor_26,_text_27,_anchor_28,_text_29,
      _text_30,_text_31,_el_32,_text_33,_el_34,_text_35,_el_36,_text_37,_text_38,_el_39,
      _text_40,_el_41,_text_42,_el_43,_text_44,_el_45,_text_46,_el_47,_text_48,_text_49,
      _el_50,_text_51,_el_52,_text_53,_el_54,_text_55,_el_56,_text_57,_text_58,_text_59,
      _text_60,_text_61,_text_62,_text_63
    ]
    ,[]);
    return null;
  }
  dynamic injectorGetInternal(dynamic token,int requestNodeIndex,dynamic notFoundResult) {
    ...
    if ((identical(token, import7.Notification) && (14 == requestNodeIndex))) { return _Notification_14_3; }
    ...
    if ((identical(token, import8.PopupSourceDirective) && (23 == requestNodeIndex))) { return _PopupSourceDirective_23_2; }
    ...
    if ((identical(token, NgIf) && (28 == requestNodeIndex))) { return _NgIf_28_5; }
    if ((identical(token, import9.PostitComponent) && (34 == requestNodeIndex))) { return _PostitComponent_34_3; }
    if ((identical(token, import10.PlacesComponent) && (36 == requestNodeIndex))) { return _PlacesComponent_36_3; }
    if ((identical(token, import11.UserListProvider) && (47 == requestNodeIndex))) { return _UserListProvider_47_3; }
    if ((identical(token, import12.SubjectListComponent) && (47 == requestNodeIndex))) { return _SubjectListComponent_47_4; }
    if ((identical(token, import13.FilesComp) && (56 == requestNodeIndex))) { return _FilesComp_56_3; }
    if ((identical(token, import22.defaultPopupPositions) && (56 == requestNodeIndex))) { return _defaultPopupPositions_56_4; }
    if ((identical(token, import47.ManagedZone) && (56 == requestNodeIndex))) { return _ManagedZone_56_5; }
    if ((identical(token, Window) && (56 == requestNodeIndex))) { return _Window_56_6; }
    if ((identical(token, import30.DomService) && (56 == requestNodeIndex))) { return _DomService_56_7; }
    if ((identical(token, import15.AcxImperativeViewUtils) && (56 == requestNodeIndex))) { return _AcxImperativeViewUtils_56_8; }
    if ((identical(token, Document) && (56 == requestNodeIndex))) { return _Document_56_9; }
    if ((identical(token, import16.DomRuler) && (56 == requestNodeIndex))) { return _DomRuler_56_10; }
    if ((identical(token, import19.overlayContainerName) && (56 == requestNodeIndex))) { return _overlayContainerName_56_11; }
    if ((identical(token, import19.overlayContainerParent) && (56 == requestNodeIndex))) { return _overlayContainerParent_56_12; }
    if ((identical(token, import19.overlayContainerToken) && (56 == requestNodeIndex))) { return _overlayContainerToken_56_13; }
    if ((identical(token, import19.overlaySyncDom) && (56 == requestNodeIndex))) { return _overlaySyncDom_56_14; }
    if ((identical(token, import17.OverlayStyleConfig) && (56 == requestNodeIndex))) { return _OverlayStyleConfig_56_15; }
    if ((identical(token, import18.ZIndexer) && (56 == requestNodeIndex))) { return _ZIndexer_56_16; }
    if ((identical(token, import19.OverlayDomRenderService) && (56 == requestNodeIndex))) { return _OverlayDomRenderService_56_17; }
    if ((identical(token, import34.OverlayService) && (56 == requestNodeIndex))) { return _OverlayService_56_18; }
    if ((identical(token, import21.DomPopupSourceFactory) && (56 == requestNodeIndex))) { return _DomPopupSourceFactory_56_19; }
    if ((identical(token, import22.PopupService) && (56 == requestNodeIndex))) { return _PopupService_56_20; }
    return notFoundResult;
  }
  void detectChangesInternal() {
    _NgIf_2_5.ngIf = (ctx.connectedUser == null);
    _NgIf_4_5.ngIf = (ctx.profilePopinVisible != null);
    _NgIf_10_5.ngIf = !ctx.isWebApp;
    final currVal_3 = (0 - 1);
    if (import48.checkBinding(_expr_3,currVal_3)) {
      _Notification_14_3.duration = currVal_3;
      _expr_3 = currVal_3;
    }
    final currVal_4 = ctx.error;
    if (import48.checkBinding(_expr_4,currVal_4)) {
      _Notification_14_3.msg = currVal_4;
      _expr_4 = currVal_4;
    }
    _NgIf_16_5.ngIf = ((ctx.messages != null) && (ctx.messages.length > 0));
    final currVal_8 = 'end';
    if (import48.checkBinding(_expr_8,currVal_8)) {
      _PopupSourceDirective_23_2.alignX = currVal_8;
      _expr_8 = currVal_8;
    }
    final currVal_9 = 'after';
    if (import48.checkBinding(_expr_9,currVal_9)) {
      _PopupSourceDirective_23_2.alignY = currVal_9;
      _expr_9 = currVal_9;
    }
    _NgIf_26_5.ngIf = (ctx.connectedUser != null);
    _NgIf_28_5.ngIf = !ctx.isWebApp;
    final currVal_12 = 'places';
    if (import48.checkBinding(_expr_12,currVal_12)) {
      _PostitComponent_34_3.name = currVal_12;
      _expr_12 = currVal_12;
    }
    final currVal_13 = 'Welcome!';
    if (import48.checkBinding(_expr_13,currVal_13)) {
      _PostitComponent_34_3.header = currVal_13;
      _expr_13 = currVal_13;
    }
    final currVal_14 = 'You can create your place on clicking on the + icon';
    if (import48.checkBinding(_expr_14,currVal_14)) {
      _PostitComponent_34_3.body = currVal_14;
      _expr_14 = currVal_14;
    }
    if ((identical(this.cdState, ChangeDetectorState.NeverChecked) && !import48.AppViewUtils.throwOnChanges)) { _PostitComponent_34_3.ngOnInit(); }
    if ((identical(this.cdState, ChangeDetectorState.NeverChecked) && !import48.AppViewUtils.throwOnChanges)) { _PlacesComponent_36_3.ngOnInit(); }
    if ((identical(this.cdState, ChangeDetectorState.NeverChecked) && !import48.AppViewUtils.throwOnChanges)) { _SubjectListComponent_47_4.ngOnInit(); }
    if ((identical(this.cdState, ChangeDetectorState.NeverChecked) && !import48.AppViewUtils.throwOnChanges)) { _FilesComp_56_3.ngOnInit(); }
    ...
    if (import48.checkBinding(_expr_7,currVal_7)) {
      setProp(_el_23,'src',import48.appViewUtils.sanitizer.sanitizeUrl(currVal_7));
      _expr_7 = currVal_7;
    }
    this.detectViewChildrenChanges();
    if (identical(this.cdState, ChangeDetectorState.NeverChecked)) { _PopupSourceDirective_23_2.ngAfterViewInit(); }
  }
  void destroyInternal() {
    _PopupSourceDirective_23_2.ngOnDestroy();
  }
...
class ViewAppComponent3 extends AppView<import3.AppComponent> {
  ...
  ViewContainer createInternal(dynamic rootSelector) {
    ...
    _el_0.setAttribute(shimCAttr,'');
    _el_0.className = 'desktopVersion';
    Text _text_1 = new Text('V0.0.49');
    _el_0.append(_text_1);
    init([_el_0],[
      _el_0,_text_1
    ]
...
class ViewAppComponent6 extends AppView<import3.AppComponent> {
  ...
  void detectChangesInternal() {
    ...
    final currVal_2 = (parent as ViewAppComponent0)._PopupSourceDirective_23_2;
