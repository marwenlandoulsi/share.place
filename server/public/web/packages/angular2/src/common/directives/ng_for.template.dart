...
import 'package:angular2/core.dart' show DoCheck, Directive, ViewContainerRef, ViewRef, TemplateRef, EmbeddedViewRef;
...
const <dynamic>[],
const [const <dynamic>[ViewContainerRef], const <dynamic>[TemplateRef]],
(ViewContainerRef _viewContainer, TemplateRef _templateRef) => new NgFor(_viewContainer, _templateRef),
