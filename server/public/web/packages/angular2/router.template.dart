...
import 'core.template.dart' as i2;
import 'src/router/instruction.template.dart' as i3;
import 'src/router/interfaces.template.dart' as i4;
import 'src/router/lifecycle/lifecycle_annotations.template.dart' as i5;
import 'src/router/route_config/route_config_decorator.template.dart' as i6;
import 'src/router/route_definition.template.dart' as i7;
import 'src/router/route_registry.template.dart' as i8;
import 'src/router/router.template.dart' as i9;
import 'src/router/router_providers.template.dart' as i10;
import 'src/router/router_providers_common.template.dart' as i11;
export 'router.dart';
...
export 'src/router/instruction.dart' show Instruction, ComponentInstruction, RouteParams, RouteData;
...
export 'src/router/router_providers.dart' show ROUTER_PROVIDERS, ROUTER_BINDINGS;
